    ...
    vb:column {
      ...
      vb:column {
        ...
        vb:text {
          font = "big",
          style = "strong",
          text = "font: big, style: strong"
        },
        vb:text {
          font = "italic",
          style = "disabled",
          text = "font: italic, style: disabled"
        },
      },
    ...
    vb:column {
      ...
      vb:row {
        ...
        vb:bitmap {
          id = "bitmapview",
          mode = "body_color",
          bitmap = "Logos/Logo.png",
          notifier = function()
            if (vb.views.bitmapview.bitmap == "Logos/Renoise.png") then
              vb.views.bitmapview.bitmap = "Logos/Logo.png"
            else
              vb.views.bitmapview.bitmap = "Logos/Renoise.png"
            end
            local mod_states = renoise.app().key_modifier_states
            local mod_string = ""
            for k,v in pairs(mod_states) do
              if (v == "pressed") then
                mod_string = mod_string .. k .. " "
              end
            end
            if (string.len(mod_string) > 0) then
              mod_string = " - modifiers: " .. mod_string
            else
              mod_string = " - no modifiers pressed"
            end
            show_status("bitmapview was pressed" .. mod_string)
          end
        },
      },
      ...
      vb:row {
        ...
        vb:checkbox {
          value = vb.views.textfield.active,
          notifier = function(value)
            vb.views.textfield.active = value
          end,
        }
      },
      ...
      vb:row {
        ...
        vb:checkbox {
          value = vb.views.multiline_textfield.active,
          notifier = function(value)
            vb.views.multiline_textfield.active = value
          end,
        }
      },
