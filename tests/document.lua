...
do
  ...
  local function list_notifier(notification)
  ...
  -- unregister class SlicedDocClass (must fail cleanly when accessed)
  _G["SlicedDocClass"] = nil
  local succeeded, errormsg = doc:load_from(tmp_filename)
  assert(not succeeded and 
    errormsg:find("'SlicedDocClass' was not registered")
  )
  ...
  local function doc_list_notifier(notification)
  ...
  assert_error(function() -- no saving/loading of raw lists
