...
do
  ...
  first_line.note_columns[1].note_value = renoise.PatternLine.NOTE_OFF
  assert_error(function()
    first_line.note_columns[1].note_value = renoise.PatternLine.EMPTY_NOTE + 1
  end)
  ...
  first_note_column.effect_number_value = 0x1*256 + 0x1
  assert(first_note_column.effect_number_value == 0x1*256 + 0x1)
  assert(first_note_column.effect_number_string == "11")

  first_note_column.effect_number_string = "0B"
  assert(first_note_column.effect_number_string == "0B")

  assert_error(function()
    first_note_column.effect_number_string = "--"
  end)

  first_note_column.effect_amount_value = 0x55
  assert(first_note_column.effect_amount_value == 0x55)

  assert_error(function()
    first_note_column.effect_amount_string = "ZZ"
  end)


  -- effectcolumn access
  
  local first_effect_column = first_line.effect_columns[1]
  
  first_effect_column.number_value = 0x1*256 + 0x1
  assert(first_effect_column.number_value == 0x1*256 + 0x1)
  assert(first_effect_column.number_string == "11")
  
  first_effect_column.amount_value = 0x55
  assert(first_effect_column.amount_value == 0x55)
  
  
  -- effectcolumn serialization
  
  first_effect_column.number_value = 0x1*256 + 0x2
  first_effect_column.number_string = ".."
  assert(first_effect_column.number_value == 
    renoise.PatternLine.EMPTY_EFFECT_NUMBER)
  first_effect_column.number_string = "42"
  assert(first_effect_column.number_string == "42")
  assert(first_effect_column.number_value == 0x4*256 + 0x2)
  assert_error(function()
    first_effect_column.number_string = "8"
  end)
  
  first_effect_column.amount_value = 0x99
  first_effect_column.amount_string = ".."
  assert(first_effect_column.amount_value == 
    renoise.PatternLine.EMPTY_EFFECT_AMOUNT)
  first_effect_column.amount_string = "FF"
  assert(first_effect_column.amount_string == "FF")
  assert(first_effect_column.amount_value == 0xFF)
  assert_error(function()
    first_effect_column.amount_string = "123"
  end)
