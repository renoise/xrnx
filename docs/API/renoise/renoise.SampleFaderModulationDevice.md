# renoise.SampleFaderModulationDevice<a name="renoise.SampleFaderModulationDevice"></a>  

<!-- toc -->
  
## Constants
### ScalingType<a name="ScalingType"></a>
> ```lua
> {
...
### scaling : [`renoise.SampleFaderModulationDevice.ScalingType`](renoise.SampleFaderModulationDevice.md#ScalingType)<a name="scaling"></a>
> Scaling mode.

### scaling_observable : [`renoise.Document.Observable`](../../API/renoise/renoise.Document.Observable.md)<a name="scaling_observable"></a>
> Track changes to document properties or general states by attaching listener
> functions to it.

### from : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="from"></a>
> Start value.

### to : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="to"></a>
> Target value.

### duration : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="duration"></a>
> Duration.
