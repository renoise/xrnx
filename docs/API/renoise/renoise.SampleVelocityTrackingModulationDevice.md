# renoise.SampleVelocityTrackingModulationDevice<a name="renoise.SampleVelocityTrackingModulationDevice"></a>  
...
### mode : [`renoise.SampleVelocityTrackingModulationDevice.Mode`](renoise.SampleVelocityTrackingModulationDevice.md#Mode)<a name="mode"></a>
> Mode.

### mode_observable : [`renoise.Document.Observable`](../../API/renoise/renoise.Document.Observable.md)<a name="mode_observable"></a>
> Track changes to document properties or general states by attaching listener
> functions to it.
