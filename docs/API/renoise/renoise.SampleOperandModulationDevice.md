# renoise.SampleOperandModulationDevice<a name="renoise.SampleOperandModulationDevice"></a>  
...
### value : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="value"></a>
> Operand value.
