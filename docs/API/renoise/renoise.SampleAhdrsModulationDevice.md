# renoise.SampleAhdrsModulationDevice<a name="renoise.SampleAhdrsModulationDevice"></a>  
...
### attack : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="attack"></a>
> with range (0-1)

### hold : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="hold"></a>
> with range (0-1)

### duration : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="duration"></a>
> with range (0-1)

### sustain : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="sustain"></a>
> with range (0-1)

### release : [`renoise.DeviceParameter`](../../API/renoise/renoise.DeviceParameter.md)<a name="release"></a>
> with range (0-1)
